...
""".trimIndent()
        ...
        val expectedPlaintext = """
            The `foo` value is defined directly in terms of itself, causing an infinite loop.Hint: The root problem is often a typo in some variable name, but I recommend
            reading <https://elm-lang.org/0.19.0/bad-recursion> for more detailed advice,
            especially if you actually do need a recursive value.
        """.trimIndent()
